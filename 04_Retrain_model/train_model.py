...
#                                  verbose=1, save_best_only=True, mode='max')
    ...
    checkpoint = ModelCheckpoint(os.path.join(model_weight_path,filepath), 
    ...
    results = model.fit_generator(myGene_train,
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Unet to detect Water areas')
    ...
    train_model(batch=int(args.batch), 
                data_path = args.data_path, 
                train_raster_file_folder_name = args.train_raster_file_folder_name, 
                train_mask_file_folder_name = args.train_mask_file_folder_name, 
                val_raster_file_folder_name = args.val_raster_file_folder_name, 
                val_mask_file_folder_name = args.val_mask_file_folder_name, 
                image_color_mode = args.image_color_mode, 
                mask_color_mode = args.mask_color_mode, 
